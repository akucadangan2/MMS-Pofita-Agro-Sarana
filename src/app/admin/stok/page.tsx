...
export default async function StokAdminPage({
  searchParams,
}: {
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-slate-500">Pantau stok barang di semua lokasi gudang (read-only)</p>
      ...
      {pageSize && (
        <Pagination halamanSekarang={halaman} totalHalaman={totalHalaman} q={q} ukuran={ukuran} basePath="/admin/stok" />
      )}
    </div>
  );
}